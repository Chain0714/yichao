...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['pullution:device:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="single"-->
<!--          @click="handleUpdate"-->
<!--          v-hasPermi="['pullution:device:edit']"-->
<!--        >修改</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="multiple"-->
<!--          @click="handleDelete"-->
<!--          v-hasPermi="['pullution:device:remove']"-->
<!--        >删除</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['pullution:device:test']"
          >测试连接</el-button>
<!--          <el-button-->
<!--            size="mini"-->
<!--            type="text"-->
...
<script>
import { listdevice, getdevice, deldevice, adddevice, testdevice, exportdevice } from "@/api/pullution/device";
...
export default {
  ...
  methods: {
    ...
    /** 提交按钮 */
    submitForm() {
      testdevice(this.form).then(response => {
