CREATE TABLE `data_log` (
                            ...
                            `st` varchar(100) DEFAULT NULL COMMENT '系统类型',
                            `cn` varchar(100) DEFAULT NULL COMMENT '命令编码',
                            `mn` varchar(100) NOT NULL COMMENT '设备编码',
                            `flag` tinyint(4) DEFAULT NULL COMMENT '标志 ',
                            `data_time` datetime NOT NULL COMMENT '数据时间',
                            PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='采集数据日志';

CREATE TABLE `factor_info` (
                               `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
                               `code` varchar(100) NOT NULL COMMENT '编码',
                               `name` varchar(100) NOT NULL COMMENT '名称',
                               `protocol_type` tinyint(4) NOT NULL COMMENT '协议类型1:2005/2:2017',
                               `unit` varchar(20) DEFAULT NULL,
                               PRIMARY KEY (`id`),
                               UNIQUE KEY `factor_info_un` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='因子信息表';

CREATE TABLE `log_detail` (
                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                              `factor_code` varchar(100) NOT NULL COMMENT '因子编码',
                              `factor_val` varchar(100) DEFAULT NULL COMMENT '因子值',
                              `log_id` bigint(20) NOT NULL COMMENT '采集日志id',
                              PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='采集日志详情';

CREATE TABLE `monitoring_point` (
                                    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
                                    `name` varchar(100) NOT NULL COMMENT '名称',
                                    `mn` varchar(100) NOT NULL COMMENT 'MN号',
                                    `org_id` bigint(20) NOT NULL COMMENT '组织id',
                                    PRIMARY KEY (`id`),
                                    UNIQUE KEY `monitoring_point_un` (`mn`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='监测点信息';
-- ----------------------------
-- 1、部门表
-- ----------------------------
